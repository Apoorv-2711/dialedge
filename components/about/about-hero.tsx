      ...
      <section className="relative py-20 overflow-hidden">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <motion.h1
              className="text-4xl md:text-6xl font-bold mb-6 font-[family-name:var(--font-work-sans)]"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              ...
              <br />
              <span className="text-foreground">Communication with AI</span>
            </motion.h1>
            ...
            >
              Since 2023, we've been on a mission to transform how businesses
              communicate with cutting-edge AI voice technology.
            </motion.p>
          </motion.div>
          <motion.div
