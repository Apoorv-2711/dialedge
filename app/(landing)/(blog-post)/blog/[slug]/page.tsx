...
export async function generateMetadata({
  ...
  const { title, description, image, metaTitle, metaDescription } = post;

  return constructMetadata({
    title: metaTitle ? `${metaTitle} – DialEdge AI` : `${title} – DialEdge AI`,
    ...
    <>
      ...
      <div className="relative">
        ...
        <MaxWidthWrapper className="grid grid-cols-4 gap-10 pt-8 max-md:px-0">
          <div className="relative col-span-4 mb-10 flex flex-col space-y-8 border-y bg-background md:rounded-xl md:border lg:col-span-3 dark:bg-white/5">
            <BlurImage
              alt={post.title}
